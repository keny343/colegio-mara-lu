...
const { listarSeries, criarSerie, atualizarSerie, deletarSerie, upload, enviarDocumento, atualizarDocumento, listarUsuarios, listarEquipaCoordenador, criarUsuario, atualizarUsuario, designarCoordenador, minhasNotificacoes, marcarNotificacaoLida, enviarNotificacao, sincronizarVagasSeries } = require('../controllers/extrasController');
const {
